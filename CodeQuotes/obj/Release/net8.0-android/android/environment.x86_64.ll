...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1138584430284552034, ; hash 0xfcd1081c1e6b762, from name: libaot-CodeQuotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 27
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3210055255126709705, ; hash 0x2c8c683f373415c9, from name: libaot-CodeQuotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 80
	...
	%struct.DSOCacheEntry {
		i64 5133047047857720886, ; hash 0x473c3f180eed4e36, from name: CodeQuotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 123
	...
	%struct.DSOCacheEntry {
		i64 6728338845595564316, ; hash 0x5d5fdc88242f791c, from name: CodeQuotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 153
	...
	%struct.DSOCacheEntry {
		i64 11480873089691061936, ; hash 0x9f54413f2e608eb0, from name: aot-CodeQuotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 291
	...
	%struct.DSOCacheEntry {
		i64 13059573136061291397, ; hash 0xb53cec931d2adb85, from name: aot-CodeQuotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 336
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f71a9f19-bb9f-4b37-839a-48ea0c9fc6d1\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.codequotes\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-CodeQuotes.dll.so\00", align 16
