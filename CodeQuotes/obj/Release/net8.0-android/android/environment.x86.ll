...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 568280966, ; hash 0x21df4786, from name: aot-CodeQuotes.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2529323898, ; hash 0x96c26b7a, from name: CodeQuotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 278
	...
	%struct.DSOCacheEntry {
		i64 2971560801, ; hash 0xb11e6b61, from name: aot-CodeQuotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 337
	...
	%struct.DSOCacheEntry {
		i64 3439700034, ; hash 0xcd05a842, from name: libaot-CodeQuotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 389
	...
	%struct.DSOCacheEntry {
		i64 3933273805, ; hash 0xea70fecd, from name: libaot-CodeQuotes
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 440
	...
	%struct.DSOCacheEntry {
		i64 4292501527, ; hash 0xffda6017, from name: CodeQuotes.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CodeQuotes.dll.so
		ptr null; void* handle (0x0)
	}, ; 478
